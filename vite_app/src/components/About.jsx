  ...
  return (
    <div className="about-container">
      ...
      <div className="vision-mission">
        ...
        <p className="vision-1">We dream of a world where tattoos are more than just
           designs. They're like personal badges that speak to your soul, showing off your
            uniqueness. At Alpha Tattoo Studio, we want to make getting a tattoo a meaningful and empower experience.</p>

         <h2 className="mission">OUR MISSION</h2>
         <p className="mission-1">To make sure you feel safe, comfortable, and excited about your tattoo journey. We're 
          here to create an art that tells your story. We want you to leave our studio not just with a tattoo, but with a
           piece of art that truly represents you.</p>   
      ...
      <div className="team4">
      <img className="parth" src="https://res.cloudinary.com/dnbayngfx/image/upload/v1738820859/th_id_OIP_4_lw9bgz.png"/>
